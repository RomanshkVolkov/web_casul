...
const catalogSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchSearchProducts.pending, (state, _action) => {
        state.loading = true;
      })
      .addCase(fetchSearchProducts.rejected, (state, _action) => {
        state.loading = false;
      ...
      .addCase(fetchSearchProductsByFilters.pending, (state, _action) => {
        state.loading = true;
      })
      .addCase(fetchSearchProductsByFilters.rejected, (state, _action) => {
        state.loading = false;
        state.pendingFetch = false;
      })
